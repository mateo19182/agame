/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.party.toml --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 35efbac16c62b0ecd6d8023e0cc5623f)
// Runtime types generated with workerd@1.20260611.1 2024-09-01 
interface __BaseEnv_CloudflareEnv {
	PARTYKIT_HOST: "agame-party.mateoamadoares.workers.dev";
	NEXTJS_ENV: string;
	PARTYKIT_DURABLE: DurableObjectNamespace<import("./party/main").GameRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./party/main");
